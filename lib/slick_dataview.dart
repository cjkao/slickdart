...
////            Object.prototype.toString = (typeof field == "") ? field :  () {
////                return this[field]
////            };
...
//            groupingInfos = groupingInfo; //(groupingInfo instanceof Array) ? groupingInfo : [groupingInfo];
//
//            for (var i = 0; i < groupingInfos.length; i++) {
//                var gi = groupingInfos[i] = $.extend(true, {}, groupingInfoDefaults, groupingInfos[i]);
//                gi.getterIsAFn = typeof gi.getter == "";
//
...
//
//            // This preserves the  template code after JS compression,
