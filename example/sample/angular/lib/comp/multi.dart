...
// import "package:angular_components/model/ui/display_name.dart";
import 'multi.template.dart' as demo;
...
class MaterialDropdownSelectDemoComponent {
  ...
  MaterialDropdownSelectDemoComponent(this._service, this._router);
  ...
  final SelectionModel<Language> multiSelectModel =
      SelectionModel.multi(selectedValues: _languagesList);
  ...
  final slideSelection = SelectionModel.multi();
