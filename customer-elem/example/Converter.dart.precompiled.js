...
["", "Converter.dart", , D, {
  "^": "",
  main: [function() {
    W.HttpRequest_getString("gss1983_Code-small.csv", null, null).then$1(new D.main_closure());
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "^": "Closure:7;",
    call$1: function(data) {
      H.setRuntimeTypeInfo(new H.MappedListIterable(J.split$1$s(data, "\r"), new D.main__closure(["A", "B", "C"])), [null, null]);
      P.print("ok");
    },
    $isFunction: true
  },
  main__closure: {
    "^": "Closure:7;colNames_0",
    call$1: function(_) {
      var cols, t1;
      cols = J.split$1$s(_, ",");
      if (0 >= cols.length)
        return H.ioore(cols, 0);
      t1 = cols[0];
      return P.LinkedHashMap_LinkedHashMap$_literal([this.colNames_0[0], t1], null, null);
    },
    $isFunction: true
  }
},
...
//# sourceMappingURL=Converter.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function main__closure(colNames_0) {
    this.colNames_0 = colNames_0;
  }
