...
["", "Bs3.dart", , E, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure(grid)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  init: function() {
    var el, column, t1, t2, t3, t4, t5, checkboxCol, elem, data, i, opt, t6, t7, sg, t8;
    el = document.querySelector("#grid");
    column = [Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["id", "title", "name", "Title1", "field", "dtitle", "sortable", true], null, null)), Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["width", 120, "id", "duration", "name", "duration", "field", "duration", "sortable", true, "editor", "TextEditor"], null, null)), Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["id", "%", "name", "percent", "field", "pc2", "sortable", true, "editor", "TextEditor"], null, null)), Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["id", "start", "name", "finish", "field", "finish"], null, null)), Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["id", "%_2", "name", "PC2", "field", "pc", "editor", "TextEditor"], null, null)), Z.Column_Column$fromMap(P.LinkedHashMap_LinkedHashMap$_literal(["id", "effort", "name", "effort", "field", "effortDriven", "width", 300], null, null))];
    t1 = P.LinkedHashMap_LinkedHashMap$_literal(["cssClass", "slick-cell-checkboxsel"], null, null);
    t2 = P.LinkedHashMap_LinkedHashMap$_literal(["columnId", "_checkbox_selector", "cssClass", null, "toolTip", "Select/Deselect All", "width", 30], null, null);
    ...
    checkboxCol = new Z.CheckboxSelectColumn(null, t2, null, new B.EventHandler([]), t3, t4, t5);
    t4.addAll$1(0, t5);
    checkboxCol.CheckboxSelectColumn$1(t1);
    elem = W.InputElement_InputElement(null);
    J.set$type$x(elem, "checkbox");
    t4.addAll$1(0, P.LinkedHashMap_LinkedHashMap$_literal(["id", checkboxCol._options.$index(0, "columnId"), "name", elem, "toolTip", checkboxCol._options.$index(0, "toolTip"), "field", "sel", "width", checkboxCol._options.$index(0, "width"), "resizable", false, "sortable", false, "cssClass", checkboxCol._options.$index(0, "cssClass"), "formatter", checkboxCol.get$checkboxSelectionFormatter()], null, null));
    C.JSArray_methods.insert$2(column, 0, checkboxCol);
    data = [];
    for (i = 0; i < 5; ++i) {
      t1 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(100));
      t2 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(100));
      t3 = C.C__JSRandom.nextInt$1(10);
      t4 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10) * 100);
      data.push(P.LinkedHashMap_LinkedHashMap$_literal(["dtitle", t1, "duration", t2, "pc2", t3 * 100, "pc", t4, "start", "01/01/2009", "finish", C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10) + 10) + "/05/2013", "effortDriven", C.JSInt_methods.$mod(i, 5) === 0], null, null));
    }
    opt = P.LinkedHashMap_LinkedHashMap$_literal(["explicitInitialization", false, "multiColumnSort", true, "editable", true, "autoEdit", true, "frozenColumn", 1], null, null);
    t1 = H.setRuntimeTypeInfo(new P.Expando(null), [Z.Column]);
    t2 = new B.Event([]);
    t3 = new B.Event([]);
    t4 = new B.Event([]);
    t5 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    t6 = P.LinkedHashMap_LinkedHashMap$_literal(["name", "", "resizable", true, "sortable", false, "minWidth", 30, "rerenderOnResize", false, "headerCssClass", null, "defaultSortAsc", true, "focusable", true, "selectable", true, "cannotTriggerInsert", false], null, null);
    t5.addAll$1(0, t6);
    t7 = [];
    sg = new R.SlickGrid(t1, el, data, column, opt, null, [], new B.Event([]), t2, new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), t3, new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), new B.Event([]), t4, new B.Event([]), null, new Z.Column(t5, t6), null, null, null, null, null, null, 0, 0, 1, false, "slickgrid_" + C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10000000)), null, null, [], [], [], null, null, [], [], [], [], null, [], null, null, null, null, null, null, 0, 0, null, null, null, null, null, null, null, false, false, 0, 0, 0, 0, null, false, 0, -1, 0, 0, 0, 0, 0, 0, 1, null, null, null, null, null, null, null, null, null, P.LinkedHashMap_LinkedHashMap$_empty(null, null), 0, null, 0, 0, 0, 0, 0, 0, null, [], t7, P.LinkedHashMap_LinkedHashMap$_empty(null, null), P.LinkedHashMap_LinkedHashMap$_empty(null, null), [], [], [], null, null, null, P.LinkedHashMap_LinkedHashMap$_empty(null, null), null, null, 0, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 0);
    sg.SlickGrid$4(el, data, column, opt);
    t6 = P.LinkedHashMap_LinkedHashMap$_literal(["selectActiveRow", false], null, null);
    t5 = new B.EventHandler([]);
    t1 = new V.RowSelectionModel(null, [], t5, false, null, P.LinkedHashMap_LinkedHashMap$_literal(["selectActiveRow", true], null, null), new B.Event([]));
    t1.RowSelectionModel$1(t6);
    t6 = sg.selectionModel;
    if (t6 != null) {
      t6 = t6.onSelectedRangesChanged;
      t8 = sg.get$handleSelectedRangesChanged();
      C.JSArray_methods.remove$1(t6.handlers, t8);
      sg.selectionModel._handler.unsubscribeAll$0();
    }
    sg.selectionModel = t1;
    t1._grid = sg;
    t5.subscribe$2(t3, t1.get$handleActiveCellChange());
    t5.subscribe$2(t1._grid.onKeyDown, t1.get$handleKeyDown());
    t5.subscribe$2(t1._grid.onClick, t1.get$handleClick());
    t1 = sg.selectionModel.onSelectedRangesChanged;
    t3 = sg.get$handleSelectedRangesChanged();
    t1.handlers.push(t3);
    t7.push(checkboxCol);
    checkboxCol.init$1(sg);
    t1 = new V.AutoTooltips(null, P.LinkedHashMap_LinkedHashMap$_literal(["enableForCells", true, "enableForHeaderCells", true, "maxToolTipLength", null], null, null), null);
    t7.push(t1);
    t1.init$1(sg);
    t4.handlers.push(new E.init_closure());
    t2.handlers.push(new E.init_closure0(data, sg));
    return sg;
  },
  main_closure: {
    "^": "Closure:26;grid_0",
    call$1: [function(e) {
      var _data, i, t1, t2, t3, t4;
      _data = [];
      for (i = 0; i < 50000; ++i) {
        t1 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(100));
        t2 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(100));
        t3 = C.C__JSRandom.nextInt$1(10);
        t4 = C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10) * 100);
        _data.push(P.LinkedHashMap_LinkedHashMap$_literal(["dtitle", t1, "duration", t2, "pc2", t3 * 100, "pc", t4, "start", "01/01/2009", "finish", C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10) + 10) + "/05/2013", "effortDriven", C.JSInt_methods.$mod(i, 5) === 0], null, null));
      }
      t1 = this.grid_0;
      t2 = t1.data;
  ...
  init_closure: {
    ...
    call$2: [function(e, args) {
      var t1, t2;
      t1 = document.querySelector(".right-pane");
      J.get$children$x(t1).clear$0(0);
      t2 = J.join$1$ax(H.listTypeCast(J.$index$asx(args, "rows")), " ");
  ...
  init_closure0: {
    ...
    call$2: [function(e, args) {
      ...
      H.IterableMixinWorkaround_sortList(t1, new E.init__closure(cols));
      t1 = this.sg_1;
      t1.updateRowCount$0();
      t1.invalidateAllRows$0();
      t1.render$0();
...
["dart.async", "dart:async", , P, {
  ...
  _BroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 41, 16, 17, 18],
    close$0: function(_) {
      var t1, doneFuture;
      t1 = this._state;
      if ((t1 & 4) !== 0)
...
["dart.dom.html", "dart:html", , W, {
  ...
  CssRect: {
    ...
    _addOrSubtractToBoxModel$2: function(dimensions, augmentingMeasurement) {
      ...
      for (t1 = H.setRuntimeTypeInfo(new H.ListIterator(dimensions, dimensions.length, 0, null), [H.getTypeArgumentByIndex(dimensions, 0)]), t2 = augmentingMeasurement === "margin", t3 = !t2, t4 = augmentingMeasurement === "content", t5 = J.getInterceptor$x(styles), val = 0; t1.moveNext$0();) {
...
["slick.column", "package:slickdart/slick_column.dart", , Z, {
  ...
  Column: {
    ...
    set$toolTip: function(item) {
      this._src.$indexSet(0, "toolTip", item);
    },
    set$previousWidth: function(item) {
      this._src.$indexSet(0, "previousWidth", item);
    },
    set$name: function(_, item) {
      this._src.$indexSet(0, "name", item);
    },
  ...
  CheckboxSelectColumn: {
    "^": "Column_IPlugin;_options,_column$_defaults,_column$_grid,_column$_handler,_selectedRowsLookup,_src,_columnDefaults",
    init$1: function(grid) {
      this._column$_grid = grid;
      this._column$_handler.subscribe$2(grid.onSelectedRowsChanged, this.get$handleSelectedRowsChanged()).subscribe$2(this._column$_grid.onClick, this.get$handleClick()).subscribe$2(this._column$_grid.onHeaderClick, this.get$handleHeaderClick()).subscribe$2(this._column$_grid.onKeyDown, this.get$handleKeyDown());
    },
    destroy$0: function() {
      this._column$_handler.unsubscribeAll$0();
    },
    handleSelectedRowsChanged$2: [function(e, args) {
      var t1, selectedRows, lookup, i, row, t2, t3;
      t1 = this._column$_grid;
      if (t1.selectionModel == null)
        H.throwExpression("Selection model is not set");
      selectedRows = t1.selectedRows;
      lookup = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      for (i = 0; i < selectedRows.length; ++i) {
        row = selectedRows[i];
        lookup.$indexSet(0, row, true);
        t1 = lookup.$index(0, row);
        t2 = this._selectedRowsLookup.$index(0, row);
        if (t1 == null ? t2 != null : t1 !== t2) {
          this._column$_grid.invalidateRows$1([row]);
          this._selectedRowsLookup.remove$1(0, row);
        }
      }
      for (t1 = this._selectedRowsLookup.get$keys(), t2 = t1._map, t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), [H.getTypeArgumentByIndex(t1, 0)]), t1._cell = t1._map._first; t1.moveNext$0();) {
        i = t1._collection$_current;
        this._column$_grid.invalidateRows$1([i]);
      }
      this._selectedRowsLookup = lookup;
      this._column$_grid.render$0();
      t1 = selectedRows.length;
      t1 = t1 > 0 && t1 === this._column$_grid.data.length;
      t2 = this._column$_grid;
      t3 = this._options;
      if (t1)
        t2.updateColumnHeader$3(t3.$index(0, "columnId"), "<input type='checkbox' checked='checked'>", this._options.$index(0, "toolTip"));
      else
        t2.updateColumnHeader$3(t3.$index(0, "columnId"), "<input type='checkbox'>", this._options.$index(0, "toolTip"));
    }, "call$2", "get$handleSelectedRowsChanged", 4, 0, 32, 3, 31],
    handleKeyDown$2: [function(e, args) {
      var t1, t2, t3, t4;
      t1 = J.getInterceptor$x(e);
      if (t1.get$which(e) === 32) {
        t2 = this._column$_grid.columns;
        t3 = J.getInterceptor$asx(args);
        t4 = t3.$index(args, "cell");
        if (t4 >>> 0 !== t4 || t4 >= t2.length)
          return H.ioore(t2, t4);
        if (J.$eq(J.get$id$x(t2[t4]), this._options.$index(0, "columnId"))) {
          if (this._column$_grid.options.$index(0, "editorLock").isActive$0() !== true || this._column$_grid.options.$index(0, "editorLock").commitCurrentEdit$0() === true)
            this.toggleRowSelection$1(t3.$index(args, "row"));
          t1.preventDefault$0(e);
          t1.stopImmediatePropagation$0(e);
        }
      }
    }, "call$2", "get$handleKeyDown", 4, 0, 55, 3, 31],
    handleClick$2: [function(e, args) {
      var evt, t1, t2, t3;
      evt = !!J.getInterceptor(e).$isEventData ? e : B.EventData_EventData$fromDom(e);
      P.print(C.JSString_methods.$add(C.JSString_methods.$add("handle from:", new H.TypeImpl(H.getRuntimeTypeString(this), null).toString$0(0)) + " ", J.toString$0(J.get$target$x(evt.get$domEvent()))));
      t1 = this._column$_grid.columns;
      t2 = J.getInterceptor$asx(args);
      t3 = t2.$index(args, "cell");
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        return H.ioore(t1, t3);
      if (J.$eq(J.get$id$x(t1[t3]), this._options.$index(0, "columnId")) && !!J.getInterceptor(J.get$target$x(evt.get$domEvent())).$isCheckboxInputElement) {
        if (this._column$_grid.options.$index(0, "editorLock").isActive$0() === true && this._column$_grid.options.$index(0, "editorLock").commitCurrentEdit$0() !== true) {
          J.preventDefault$0$x(evt.get$domEvent());
          J.stopImmediatePropagation$0$x(evt.get$domEvent());
          evt.set$_isImmediatePropagationStopped(true);
          return;
        }
        this.toggleRowSelection$1(t2.$index(args, "row"));
        J.stopPropagation$0$x(evt.get$domEvent());
        evt.set$_isPropagationStopped(true);
        J.stopImmediatePropagation$0$x(evt.get$domEvent());
        evt.set$_isImmediatePropagationStopped(true);
      }
    }, "call$2", "get$handleClick", 4, 0, 55, 3, 31],
    toggleRowSelection$1: function(row) {
      var t1, list;
      t1 = this._column$_grid;
      if (t1.selectionModel == null)
        H.throwExpression("Selection model is not set");
      list = t1.selectedRows;
      if (this._selectedRowsLookup.containsKey$1(row))
        C.JSArray_methods.remove$1(list, row);
      else
        list.push(row);
      this._column$_grid.setSelectedRows$1(list);
    },
    handleHeaderClick$2: [function(evt, args) {
      var e, t1, rows, i, t2;
      e = evt.get$domEvent();
      if (J.$eq(H.interceptedTypeCast(J.$index$asx(args, "column"), "$isColumn")._src.$index(0, "id"), this._options.$index(0, "columnId")) && !!J.getInterceptor(J.get$target$x(e)).$isCheckboxInputElement) {
        if (this._column$_grid.options.$index(0, "editorLock").isActive$0() === true && this._column$_grid.options.$index(0, "editorLock").commitCurrentEdit$0() !== true) {
          t1 = J.getInterceptor$x(e);
          t1.preventDefault$0(e);
          t1.stopImmediatePropagation$0(e);
        ...
        t1 = J.getInterceptor$x(e);
        if (!!J.getInterceptor(t1.get$target(e)).$isCheckboxInputElement && J.get$checked$x(H.interceptedTypeCast(t1.get$target(e), "$isCheckboxInputElement")) === true) {
          rows = [];
          for (i = 0; t2 = this._column$_grid, i < t2.data.length; ++i)
            rows.push(i);
          t2.setSelectedRows$1(rows);
        } else
          this._column$_grid.setSelectedRows$1([]);
        t1.stopPropagation$0(e);
        t1.stopImmediatePropagation$0(e);
      }
    }, "call$2", "get$handleHeaderClick", 4, 0, 32, 56, 31],
    checkboxSelectionFormatter$5: [function(row, cell, value, columnDef, dataContext) {
      if (dataContext != null)
        return this._selectedRowsLookup.containsKey$1(row) ? "<input type='checkbox' checked='checked'>" : "<input type='checkbox'>";
      return;
    }, "call$5", "get$checkboxSelectionFormatter", 10, 0, 57, 58, 59, 14, 60, 61],
    CheckboxSelectColumn$1: function(options) {
      var t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t1.addAll$1(0, this._column$_defaults);
      this._options = t1;
...
["slick.core", "package:slickdart/slick_core.dart", , B, {
  ...
  Range: {
    ...
    toString$0: function(_) {
      var t1, t2;
      if (J.$eq(this.fromRow, this.toRow)) {
        t1 = this.fromCell;
        t2 = this.toCell;
        t2 = t1 == null ? t2 == null : t1 === t2;
        t1 = t2;
...
["slick.grid", "package:slickdart/slick_grid.dart", , R, {
  ...
  SlickGrid: {
    ...
    handleSelectedRangesChanged$2: [function(e, ranges) {
      var hash, t1, t2, t3, i, t4, j, k, t5, prevHash;
      this.selectedRows = [];
      ...
      i = 0;
      while (true) {
        t4 = t1.get$length(ranges);
        if (typeof t4 !== "number")
          return H.iae(t4);
        if (!(i < t4))
          break;
        for (j = t1.$index(ranges, i).get$fromRow(); t4 = J.getInterceptor$n(j), t4.$le(j, t1.$index(ranges, i).get$toRow()); j = t4.$add(j, 1)) {
          if (!hash.containsKey$1(j)) {
            this.selectedRows.push(j);
            hash.$indexSet(0, j, P.LinkedHashMap_LinkedHashMap$_empty(null, null));
          }
          k = t1.$index(ranges, i).get$fromCell();
          while (true) {
            t5 = t1.$index(ranges, i).get$toCell();
            if (typeof k !== "number")
              return k.$le();
            if (typeof t5 !== "number")
              return H.iae(t5);
            ...
            if (this.canCellBeSelected$2(j, k) === true) {
              ...
              if (k < 0 || k >= t2.length)
                return H.ioore(t2, k);
              J.$indexSet$ax(t5, J.get$id$x(t2[k]), t3.$index(0, "selectedCellCssClass"));
            }
            ++k;
          }
        }
      ...
      t1 = t3.$index(0, "selectedCellCssClass");
    ...
    }, "call$2", "get$handleSelectedRangesChanged", 4, 0, 65, 3, 66],
    updateCellCssStylesOnRenderedRows$2: function(addedHash, removedHash) {
      ...
      for (t1 = this.rowsCache.get$keys(), t2 = t1._map, t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), [H.getTypeArgumentByIndex(t1, 0)]), t1._cell = t1._map._first, t2 = removedHash == null, node = null, columnId = null; t1.moveNext$0();) {
        row = t1._collection$_current;
        removedRowHash = t2 ? null : removedHash.$index(0, row);
    ...
    }, "render$0", "call$1", "call$0", "get$render", 0, 2, 67, 16],
    ...
    }, "resizeCanvas$0", "call$1", "call$0", "get$resizeCanvas", 0, 2, 68, 16, 3],
    ...
    }, "defaultFormatter$4", "call$5", "call$3", "call$4", "get$defaultFormatter", 6, 4, 69, 16, 16, 58, 59, 14, 60, 61],
    ...
    updateColumnHeader$3: function(columnId, title, toolTip) {
      var idx, t1, columnDef, t2, $$header;
      if (!this.initialized)
        return;
      idx = this.columnsById.$index(0, columnId);
      if (idx == null)
        return;
      t1 = this.columns;
      if (idx !== (idx | 0) || idx >= t1.length)
        return H.ioore(t1, idx);
      columnDef = t1[idx];
      t2 = H.setRuntimeTypeInfo(new H.ExpandIterable(this.$$headers, new R.SlickGrid_updateColumnHeader_closure()), [null, null]);
      t2 = P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "IterableBase", 0));
      if (idx !== (idx | 0) || idx >= t2.length)
        return H.ioore(t2, idx);
      $$header = t2[idx];
      if ($$header != null) {
        if (idx !== (idx | 0) || idx >= t1.length)
          return H.ioore(t1, idx);
        J.set$name$x(t1[idx], title);
        if (toolTip != null) {
          if (idx !== (idx | 0) || idx >= t1.length)
            return H.ioore(t1, idx);
          t1[idx].set$toolTip(toolTip);
        }
        this.trigger$2(this.onBeforeHeaderCellDestroy, P.LinkedHashMap_LinkedHashMap$_literal(["node", $$header, "column", columnDef], null, null));
        t1 = J.getInterceptor$x($$header);
        t1.get$attributes($$header).putIfAbsent$2("title", new R.SlickGrid_updateColumnHeader_closure0(toolTip));
        J.set$innerHtml$x(J.get$first$ax(t1.get$children($$header)), title);
        this.trigger$2(this.onHeaderCellRendered, P.LinkedHashMap_LinkedHashMap$_literal(["node", $$header, "column", columnDef], null, null));
      }
    },
    createColumnHeaders$0: function() {
      ...
      for (t3 = this.columns, t4 = this.options, t5 = this.onHeaderCellRendered, t6 = this._headExt, t7 = this.uid, t8 = this.onHeaderRowCellRendered, i = 0; i < t3.length; ++i) {
        ...
        if (J.$eq(t4.$index(0, "enableColumnReorder"), true) || J.$eq(t10.$index(m, "sortable"), true)) {
          ...
          t12 = t11._eventType;
          t13 = t11._useCapture;
          t14 = new W._EventStreamSubscription(0, t11._target, t12, W._wrapZone(t1), t13);
          t14.$builtinTypeInfo = [H.getTypeArgumentByIndex(t11, 0)];
          t11 = t14._onData;
          if (t11 != null && t14._pauseCount <= 0)
            J.addEventListener$3$x(t14._target, t12, t11, t13);
          t11 = t9.get$onMouseLeave(header);
          t12 = t11._eventType;
          t13 = t11._useCapture;
          t14 = new W._EventStreamSubscription(0, t11._target, t12, W._wrapZone(t2), t13);
          t14.$builtinTypeInfo = [H.getTypeArgumentByIndex(t11, 0)];
          t11 = t14._onData;
          if (t11 != null && t14._pauseCount <= 0)
            J.addEventListener$3$x(t14._target, t12, t11, t13);
    ...
    setupColumnResize$0: function() {
      ...
      for (t1.i_7 = 0, t2 = this.options, $$col = null, t3 = 0; t4 = columnElements.length, t3 < t4; t3 = ++t1.i_7) {
        ...
        t5 = t4._eventType;
        t6 = t4._useCapture;
        t7 = new W._EventStreamSubscription(0, t4._target, t5, W._wrapZone(new R.SlickGrid_setupColumnResize_closure2(t1, this, columnElements, resizeItem)), t6);
        ...
        t5 = t4._eventType;
        t6 = t4._useCapture;
        t7 = new W._EventStreamSubscription(0, t4._target, t5, W._wrapZone(new R.SlickGrid_setupColumnResize_closure3(t1, this, columnElements)), t6);
        t7.$builtinTypeInfo = [H.getTypeArgumentByIndex(t4, 0)];
        t4 = t7._onData;
        if (t4 != null && t7._pauseCount <= 0)
          J.addEventListener$3$x(t7._target, t5, t4, t6);
        ...
        t4 = t3._eventType;
        t5 = t3._useCapture;
        t6 = new W._EventStreamSubscription(0, t3._target, t4, W._wrapZone(new R.SlickGrid_setupColumnResize_closure4(t1, this, columnElements, item)), t5);
    ...
    invalidateRows$1: function(rows) {
      var t1, i;
      this.vScrollDir = 0;
      for (t1 = this.rowsCache, i = 0; i < 1; ++i) {
        if (this.currentEditor != null && J.$eq(this.activeRow, rows[i]))
          this.makeActiveCellNormal$0();
        if (t1.$index(0, rows[i]) != null)
          this.removeRowFromCache$1(rows[i]);
      }
    },
    ...
    cleanupRows$1: function(rangeToKeep) {
      ...
      for (t1 = P.List_List$from(this.rowsCache.get$keys(), true, null), t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]), t2 = this.options; t1.moveNext$0();) {
    ...
    commitCurrentEdit$0: [function() {
      ...
      return true;
    }, "call$0", "get$commitCurrentEdit", 0, 0, 35],
    cancelCurrentEdit$0: [function() {
      this.makeActiveCellNormal$0();
      return true;
    }, "call$0", "get$cancelCurrentEdit", 0, 0, 43],
    ...
    setSelectedRows$1: function(rows) {
      var t1, t2;
      t1 = this.selectionModel;
      if (t1 == null)
        throw H.wrapException("Selection model is not set");
      t2 = this.rowsToRanges$1(rows);
      t1._ranges = t2;
      t1.onSelectedRangesChanged.notify$1(t2);
    },
    ...
    updateRowPositions$0: function() {
      var t1, t2, t3, row;
      for (t1 = this.rowsCache, t2 = t1.get$keys(), t3 = t2._map, t2 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null), [H.getTypeArgumentByIndex(t2, 0)]), t2._cell = t2._map._first; t2.moveNext$0();) {
    ...
    cleanUpCells$2: function(range, row) {
      ...
      cacheEntry = this.rowsCache.$index(0, row);
      cellsToRemove = [];
      for (t2 = cacheEntry.get$cellNodesByColumnIdx().get$keys(), t3 = t2._map, t2 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null), [H.getTypeArgumentByIndex(t2, 0)]), t2._cell = t2._map._first, t3 = this.columns, t4 = J.getInterceptor(row); t2.moveNext$0();) {
        i = t2._collection$_current;
    ...
    }, "call$1", "get$handleClick", 2, 0, 62, 3],
    ...
    }, "call$1", "get$handleDblClick", 2, 0, 62, 3],
    setFocus$0: function() {
    ...
    getRowFromNode$1: function(rowNode) {
      var t1, t2, t3, row, t4;
      for (t1 = this.rowsCache, t2 = t1.get$keys(), t3 = t2._map, t2 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null), [H.getTypeArgumentByIndex(t2, 0)]), t2._cell = t2._map._first, t3 = this.options; t2.moveNext$0();) {
        row = t2._collection$_current;
        ...
        if (J.$eq(t4[0], rowNode))
          return row;
        if (J.$ge$n(t3.$index(0, "frozenColumn"), 0)) {
          t4 = t1.$index(0, row).get$rowNode();
          if (1 >= t4.length)
            return H.ioore(t4, 1);
    ...
    scrollRowIntoView$2: function(row, doPaging) {
      ...
      if (t1.$gt(rowTopDist, t2 + t3 + this.offset)) {
        this.scrollTo$1(0, doPaging != null ? rowTopDist : rowAtBottom);
        this.render$0();
      } else if (t1.$lt(rowTopDist, this.scrollTop + this.offset)) {
        this.scrollTo$1(0, doPaging != null ? rowAtBottom : rowTopDist);
        this.render$0();
      }
    },
    scrollRowIntoView$1: function(row) {
      return this.scrollRowIntoView$2(row, null);
    },
    ...
    setActiveCell$2: function(row, cell) {
      var t1;
      if (!this.initialized)
        return;
      t1 = J.getInterceptor$n(row);
      if (!t1.$gt(row, this.data.length))
        if (!t1.$lt(row, 0)) {
          t1 = J.getInterceptor$n(cell);
          t1 = t1.$ge(cell, this.columns.length) || t1.$lt(cell, 0);
        } else
      ...
      if (t1)
        return;
      if (this.options.$index(0, "enableCellNavigation") != null)
        return;
      this.scrollCellIntoView$3(row, cell, false);
      this.setActiveCellInternal$2(this.getCellNode$2(row, cell), false);
    },
    ...
    }, "call$0", "get$asyncPostProcessRows", 0, 0, 35],
    ...
    appendCellHtml$5: function(stringArray, row, cell, colspan, item) {
      var t1, m, t2, cellCss, t3, t4, key, style, value;
      t1 = this.columns;
      ...
      if (J.$eq(row, this.activeRow) && cell === this.activeCell)
        cellCss += " active";
      t1 = this.cellCssClasses;
      t2 = t1.get$keys();
      t3 = t2._map;
      t4 = new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null);
    ...
    }, "call$1", "get$handleHeaderRowScroll", 2, 0, 70, 3],
    ...
    }, "handleScroll$0", "call$1", "call$0", "get$handleScroll", 0, 2, 68, 16, 3],
    ...
    }, "call$1", "get$handleHeaderMouseEnter", 2, 0, 62, 3],
    ...
    }, "call$1", "get$handleHeaderContextMenu", 2, 0, 71, 3],
    ...
    }, "call$1", "get$handleHeaderClick", 2, 0, 70, 3],
    ...
    }, "handleKeyDown$1", "call$2", "call$1", "get$handleKeyDown", 2, 2, 75, 16, 3, 31],
  ...
  SlickGrid_updateColumnHeader_closure: {
    "^": "Closure:26;",
    call$1: function(i) {
      return J.get$children$x(i);
    },
  ...
  SlickGrid_updateColumnHeader_closure0: {
    "^": "Closure:35;toolTip_0",
    call$0: function() {
  ...
  SlickGrid_setupColumnResize_closure2: {
    "^": "Closure:77;box_0,this_4,columnElements_5,resizeItem_6",
    call$1: [function(e) {
  ...
  SlickGrid_setupColumnResize_closure3: {
    "^": "Closure:77;box_0,this_7,columnElements_8",
    call$1: [function(e) {
  ...
  SlickGrid_setupColumnResize_closure4: {
    "^": "Closure:77;box_0,this_9,columnElements_10,item_11",
    call$1: [function(e) {
  ...
  SlickGrid__cleanUpAndRenderCells__helper: {
    "^": "Closure:79;box_0,this_1,range_2,stringArray_3,processedRows_4",
    call$1: function(row) {
...
["slick.plugin", "package:slickdart/plugin/autotooltip.dart", , V, {
  "^": "",
  AutoTooltips: {
    "^": "IPlugin;_plugin$_grid,_defaults,_plugin$_options",
    init$1: function(grid) {
      var t1, t2;
      t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t1.addAll$1(0, this._defaults);
      this._plugin$_options = t1;
      t1.addAll$1(0, grid.options);
      this._plugin$_grid = grid;
      if (this._plugin$_options.$index(0, "enableForCells") === true) {
        t1 = this._plugin$_grid.onMouseEnter;
        t2 = this.get$handleMouseEnter();
        t1.handlers.push(t2);
      }
      if (this._plugin$_options.$index(0, "enableForHeaderCells") === true) {
        t1 = this._plugin$_grid.onHeaderMouseEnter;
        t2 = this.get$handleHeaderMouseEnter();
        t1.handlers.push(t2);
      }
    },
    destroy$0: function() {
    ...
    handleMouseEnter$2: [function(e, arg) {
      ...
      cell = this._plugin$_grid.getCellFromEvent$1(e);
      if (cell != null) {
        $$node = this._plugin$_grid.getCellNode$2(cell.$index(0, "row"), cell.$index(0, "cell"));
        t1 = J.getInterceptor$x($$node);
        ...
        if (J.get$offsetWidth$x(t2._element) + t2._addOrSubtractToBoxModel$2($.get$_WIDTH(), "padding") < t1.get$scrollWidth($$node)) {
          ...
          if (this._plugin$_options.$index(0, "maxToolTipLength") != null) {
            t2 = text.length;
            t3 = this._plugin$_options.$index(0, "maxToolTipLength");
            if (typeof t3 !== "number")
              return H.iae(t3);
            t3 = t2 > t3;
            t2 = t3;
            ...
            t2 = false;
          if (t2)
            text = J.substring$2$s(text, 0, J.$sub$n(this._plugin$_options.$index(0, "maxToolTipLength"), 3)) + "...";
        } else
          text = "";
    ...
    }, "handleMouseEnter$1", "call$2", "call$1", "get$handleMouseEnter", 2, 2, 81, 16, 3, 47],
    ...
    }, "call$2", "get$handleHeaderMouseEnter", 4, 0, 32, 3, 31]
  }
}],
["slick.selection", "package:slickdart/slick_selectionmodel.dart", , V, {
  ...
  RowSelectionModel: {
    "^": "SelectionModel;_grid,_ranges,_handler,_inHandler,_selection$_options,_selection$_defaults,onSelectedRangesChanged",
    destroy$0: function() {
      this._handler.unsubscribeAll$0();
    },
    rangesToRows$1: function(ranges) {
      var rows, i, j, t1;
      rows = [];
      for (i = 0; i < ranges.length; ++i) {
        j = ranges[i].get$fromRow();
        while (true) {
          if (i >= ranges.length)
            return H.ioore(ranges, i);
          t1 = J.getInterceptor$n(j);
          if (!t1.$le(j, ranges[i].get$toRow()))
            break;
          rows.push(j);
          j = t1.$add(j, 1);
        }
    ...
    rowsToRanges$1: function(rows) {
      var ranges, lastCell, i, t1;
      ranges = [];
      lastCell = this._grid.columns.length - 1;
      for (i = 0; i < rows.length; ++i) {
        t1 = rows[i];
        ranges.push(B.Range$(t1, 0, t1, lastCell));
      }
    ...
    getRowsRange$2: function(from, to) {
      var rows, i, t1;
      rows = [];
      for (i = from; t1 = J.getInterceptor$n(i), t1.$le(i, to); i = t1.$add(i, 1))
        rows.push(i);
      for (i = to; t1 = J.getInterceptor$n(i), t1.$lt(i, from); i = t1.$add(i, 1))
        rows.push(i);
      return rows;
    },
    handleActiveCellChange$2: [function(e, data) {
      var t1;
      if (this._selection$_options.$index(0, "selectActiveRow") === true && J.$index$asx(data, "row") != null) {
        t1 = J.getInterceptor$asx(data);
        t1 = [B.Range$(t1.$index(data, "row"), 0, t1.$index(data, "row"), this._grid.columns.length - 1)];
        this._ranges = t1;
        this.onSelectedRangesChanged.notify$1(t1);
      }
    }, "call$2", "get$handleActiveCellChange", 4, 0, 82, 3, 40],
    handleKeyDown$2: [function(e, args) {
      var activeRow, t1, selectedRows, $top, t2, bottom, active;
      activeRow = this._grid.getActiveCell$0();
      if (activeRow != null) {
        t1 = J.getInterceptor$x(e);
        if (t1.get$shiftKey(e) === true)
          if (t1.get$ctrlKey(e) !== true)
            if (t1.get$altKey(e) !== true)
              if (t1.get$metaKey(e) !== true)
                t1 = t1.get$which(e) === 38 || t1.get$which(e) === 40;
              else
                t1 = false;
            else
              t1 = false;
        ...
        t1 = false;
      if (t1) {
        selectedRows = this.rangesToRows$1(this._ranges);
        C.JSArray_methods.checkMutable$1(selectedRows, "sort");
        H.IterableMixinWorkaround_sortList(selectedRows, new V.RowSelectionModel_handleKeyDown_closure());
        if (selectedRows.length === 0)
          selectedRows = [activeRow.$index(0, "row")];
        t1 = selectedRows.length;
        if (0 >= t1)
          return H.ioore(selectedRows, 0);
        $top = selectedRows[0];
        t2 = t1 - 1;
        if (t2 < 0)
          return H.ioore(selectedRows, t2);
        bottom = selectedRows[t2];
        t1 = J.getInterceptor$x(e);
        if (t1.get$which(e) === 40)
          if (J.$lt$n(activeRow.$index(0, "row"), bottom) || J.$eq($top, bottom)) {
            bottom = J.$add$ns(bottom, 1);
            active = bottom;
          } else {
            $top = J.$add$ns($top, 1);
            active = $top;
          }
        else if (J.$lt$n(activeRow.$index(0, "row"), bottom)) {
          bottom = J.$sub$n(bottom, 1);
          active = bottom;
        } else {
          $top = J.$sub$n($top, 1);
          active = $top;
        }
        t2 = J.getInterceptor$n(active);
        if (t2.$ge(active, 0) && t2.$lt(active, this._grid.data.length)) {
          this._grid.scrollRowIntoView$1(active);
          t2 = this.rowsToRanges$1(this.getRowsRange$2($top, bottom));
          this._ranges = t2;
          this._ranges = t2;
      ...
      return this.handleKeyDown$2(e, null);
    }, "handleKeyDown$1", "call$2", "call$1", "get$handleKeyDown", 2, 2, 83, 16, 3, 31],
    handleClick$2: [function(e, args) {
      var evt, t1, domEvt, cell, selection, idx, t2, t3, t4, last, from, to, i;
      evt = !!J.getInterceptor(e).$isMouseEvent ? B.EventData_EventData$fromDom(e) : e;
      t1 = J.getInterceptor$x(evt);
      P.print(C.JSString_methods.$add(C.JSString_methods.$add("handle from:", new H.TypeImpl(H.getRuntimeTypeString(this), null).toString$0(0)) + " ", J.toString$0(t1.get$target(evt))));
      domEvt = evt.get$domEvent();
      cell = this._grid.getCellFromEvent$1(evt);
      if (cell == null || this._grid.canCellBeActive$2(cell.$index(0, "row"), cell.$index(0, "cell")) !== true)
        return false;
      selection = this.rangesToRows$1(this._ranges);
      idx = H.Lists_indexOf(selection, cell.$index(0, "row"), 0, selection.length);
      t2 = J.getInterceptor$x(domEvt);
      if (t2.get$ctrlKey(domEvt) !== true && t2.get$shiftKey(domEvt) !== true && t2.get$metaKey(domEvt) !== true)
        return false;
      else if (this._grid.options.$index(0, "multiSelect") === true) {
        t3 = idx === -1;
        if (t3)
          t4 = t2.get$ctrlKey(domEvt) === true || t2.get$metaKey(domEvt) === true;
        else
          t4 = false;
        if (t4) {
          selection.push(cell.$index(0, "row"));
          this._grid.setActiveCell$2(cell.$index(0, "row"), cell.$index(0, "cell"));
        } else {
          if (!t3)
            t3 = t2.get$ctrlKey(domEvt) === true || t2.get$metaKey(domEvt) === true;
          else
            t3 = false;
          if (t3) {
            C.JSArray_methods.retainWhere$1(selection, new V.RowSelectionModel_handleClick_closure(cell));
            this._grid.setActiveCell$2(cell.$index(0, "row"), cell.$index(0, "cell"));
          } else if (selection.length > 0 && t2.get$shiftKey(domEvt) === true) {
            last = C.JSArray_methods.get$last(selection);
            from = P.min(cell.$index(0, "row"), last);
            to = P.max(cell.$index(0, "row"), last);
            selection = [];
            for (i = from; i <= to; ++i)
              if (i !== last)
                selection.push(i);
      ...
      t2 = this.rowsToRanges$1(selection);
      this._ranges = t2;
      this._ranges = t2;
      this.onSelectedRangesChanged.notify$1(t2);
      ...
      return this.handleClick$2(e, null);
    }, "handleClick$1", "call$2", "call$1", "get$handleClick", 2, 2, 84, 16, 3, 31],
    RowSelectionModel$1: function(options) {
      var t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t1.addAll$1(0, this._selection$_defaults);
      this._selection$_options = t1;
      t1.addAll$1(0, options);
    }
  },
  RowSelectionModel_handleKeyDown_closure: {
    "^": "Closure:33;",
    call$2: function(x, y) {
      return J.$sub$n(x, y);
    },
  ...
  RowSelectionModel_handleClick_closure: {
    "^": "Closure:26;cell_0",
    call$1: function(item) {
      return !J.$eq(item, this.cell_0.$index(0, "row"));
    },
    $isFunction: true
  }
}],
...
{func: "dynamic__dynamic_Map0", args: [null, [P.Map, P.String, null]]},
{func: "dynamic__KeyboardEvent__Map", args: [W.KeyboardEvent], opt: [[P.Map, P.String, null]]},
{func: "bool__dynamic__Map", ret: P.bool, args: [null], opt: [[P.Map, P.String, null]]},
];
$ = null;
