...
["", "dnd.dart", , G, {
  "^": "",
  main: [function() {
    new G.Basics(null).start$0(0);
  }, "call$0", "main$closure", 0, 0, 1],
  Basics: {
    "^": "Object;_dragSourceEl",
    start$0: function(_) {
      var cols, t1, col, t2;
      cols = W._FrozenElementList$_wrap(document.querySelectorAll(".slick-resizable-handle"), null);
    ...
    _onDragStart$1: [function($event) {
      ...
      $event.dataTransfer.setData("text/html", t2.get$innerHtml(dragTarget));
    }, "call$1", "get$_onDragStart", 2, 0, 24],
    ...
    }, "call$1", "get$_onDragEnd", 2, 0, 24],
    _onDragEnter$1: [function($event) {
      J.get$classes$x(J.get$target$x($event)).add$1(0, "over");
    }, "call$1", "get$_onDragEnter", 2, 0, 24],
    _onDragOver$1: [function($event) {
      var t1 = J.getInterceptor$x($event);
      t1.preventDefault$0($event);
      t1.get$dataTransfer($event).dropEffect = "move";
    }, "call$1", "get$_onDragOver", 2, 0, 24],
    _onDragLeave$1: [function($event) {
      J.get$classes$x(J.get$target$x($event)).remove$1(0, "over");
    }, "call$1", "get$_onDragLeave", 2, 0, 24],
    _onDrop$1: [function($event) {
      var t1, dropTarget, t2, t3;
      t1 = J.getInterceptor$x($event);
      t1.stopPropagation$0($event);
      dropTarget = W._convertNativeToDart_EventTarget($event.target);
      t2 = this._dragSourceEl;
      if (t2 == null ? dropTarget != null : t2 !== dropTarget) {
        t3 = J.getInterceptor$x(dropTarget);
        J.set$innerHtml$x(t2, t3.get$innerHtml(dropTarget));
        t3.set$innerHtml(dropTarget, t1.get$dataTransfer($event).getData("text/html"));
      }
    }, "call$1", "get$_onDrop", 2, 0, 24]
  }
},
1],
...
//# sourceMappingURL=dnd.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function Basics(_dragSourceEl) {
    this._dragSourceEl = _dragSourceEl;
  }
  Basics.builtin$cls = "Basics";
  if (!"name" in Basics)
    Basics.name = "Basics";
  $desc = $collectedClasses.Basics;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Basics.prototype = $desc;
