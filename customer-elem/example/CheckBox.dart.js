...
["", "CheckBox.dart", , Z, {
  ...
  init: function() {
    var el, column, t1, t2, t3, t4, t5, checkboxCol, elem, data, i, opt, t6, t7, sg, rsm;
    el = document.querySelector("#grid");
    column = Z.ColumnList_ColumnList$fromMap([P.LinkedHashMap_LinkedHashMap$_literal(["width", 130, "field", "idi", "sortable", true, "editor", "TextEditor"], null, null), P.LinkedHashMap_LinkedHashMap$_literal(["width", 120, "field", "duration", "sortable", true], null, null), P.LinkedHashMap_LinkedHashMap$_literal(["field", "pc", "sortable", true], null, null), P.LinkedHashMap_LinkedHashMap$_literal(["width", 400, "field", "finish"], null, null)]);
    ...
    column.insert$2(column, 0, checkboxCol);
    data = [];
    for (i = 0; i < 50;) {
      ...
      ++i;
      data.push(P.LinkedHashMap_LinkedHashMap$_literal(["title", t1, "duration", t2, "pc", t3 * 100, "idi", i, "finish", C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(10) + 10) + "/05/2013"], null, null));
    }
    opt = P.LinkedHashMap_LinkedHashMap$_literal(["explicitInitialization", false, "multiColumnSort", true, "editable", true, "autoEdit", false, "frozenColumn", 1], null, null);
    ...
    rsm = new V.RowSelectionModel(null, [], t5, false, null, P.LinkedHashMap_LinkedHashMap$_literal(["selectActiveRow", true], null, null), new B.Event([]));
    rsm.RowSelectionModel$1(t6);
    t4.handlers.push(new Z.init_closure(rsm));
    t1 = sg.selectionModel;
    if (t1 != null) {
      t1 = t1.onSelectedRangesChanged;
      t6 = sg.get$handleSelectedRangesChanged();
      C.JSArray_methods.remove$1(t1.handlers, t6);
      sg.selectionModel._handler.unsubscribeAll$0();
    }
    sg.selectionModel = rsm;
    rsm._grid = sg;
    t5.subscribe$2(t3, rsm.get$handleActiveCellChange());
    t5.subscribe$2(rsm._grid.onKeyDown, rsm.get$handleKeyDown());
    t5.subscribe$2(rsm._grid.onClick, rsm.get$handleClick());
    t1 = sg.selectionModel.onSelectedRangesChanged;
    t3 = sg.get$handleSelectedRangesChanged();
    t1.handlers.push(t3);
    t7.push(checkboxCol);
    checkboxCol._column$_grid = sg;
    checkboxCol._column$_handler.subscribe$2(t4, checkboxCol.get$handleSelectedRowsChanged()).subscribe$2(checkboxCol._column$_grid.onClick, checkboxCol.get$handleClick()).subscribe$2(checkboxCol._column$_grid.onHeaderClick, checkboxCol.get$handleHeaderClick()).subscribe$2(checkboxCol._column$_grid.onKeyDown, checkboxCol.get$handleKeyDown());
    t2.handlers.push(new Z.init_closure0(data, sg));
    return sg;
  },
  main_closure: {
    "^": "Closure:26;g_0",
    call$1: [function(e) {
      ...
      for (i = 0; i < 50000; ++i) {
        ...
        _data.push(P.LinkedHashMap_LinkedHashMap$_literal(["idi", i, "title", t1, "duration", C.JSInt_methods.toString$0(C.C__JSRandom.nextInt$1(1000)), "pc", i], null, null));
      }
      t1 = this.g_0;
      t2 = t1.data;
  ...
  init_closure: {
    ...
    call$2: [function(e, args) {
      var t1 = this.rsm_0;
      P.print(t1.rangesToRows$1(t1._ranges).length);
    }, "call$2", null, 4, 0, null, 3, 31, "call"],
    $isFunction: true
  },
  init_closure0: {
    "^": "Closure:32;data_1,sg_2",
    call$2: [function(e, args) {
      var cols, t1;
...
["dart.dom.html", "dart:html", , W, {
  ...
  _DataAttributeMap: {
    ...
    containsKey$1: function(key) {
      return this._attributes._html$_element.hasAttribute("data-" + H.S(this._toHyphenedName$1(key)));
    },
    $index: function(_, key) {
      return this._attributes._html$_element.getAttribute("data-" + H.S(this._toHyphenedName$1(key)));
    },
    $indexSet: function(_, key, value) {
      this._attributes._html$_element.setAttribute("data-" + H.S(this._toHyphenedName$1(key)), value);
    },
    remove$1: function(_, key) {
      var t1, t2, value;
  ...
  _DataAttributeMap_addAll_closure: {
    ...
    call$2: function(k, v) {
      var t1 = this.this_0;
      t1._attributes._html$_element.setAttribute("data-" + H.S(t1._toHyphenedName$1(k)), v);
    },
    $isFunction: true
  },
  ...
  _ContentCssRect: {
    ...
    get$height: function(_) {
      return J.get$offsetHeight$x(this._html$_element) + this._addOrSubtractToBoxModel$2($.get$_HEIGHT(), "content");
    },
    get$width: function(_) {
      return J.get$offsetWidth$x(this._html$_element) + this._addOrSubtractToBoxModel$2($.get$_WIDTH(), "content");
    },
    set$width: function(_, newWidth) {
      ...
      if (!!t1.$isDimension) {
        ...
        J.set$width$x(J.get$style$x(this._html$_element), H.S(newWidth._html$_value) + H.S(newWidth._unit));
      } else {
        if (t1.$lt(newWidth, 0))
          newWidth = 0;
        J.set$width$x(J.get$style$x(this._html$_element), H.S(newWidth) + "px");
      }
    },
    get$left: function(_) {
      var t1, t2;
  ...
  _BorderCssRect: {
    "^": "CssRect;_html$_element,left,top,_width,_height",
    get$height: function(_) {
      return J.get$offsetHeight$x(this._html$_element);
    },
    get$width: function(_) {
      return J.get$offsetWidth$x(this._html$_element);
    },
    get$left: function(_) {
      return J.get$left$x(J.getBoundingClientRect$0$x(this._html$_element));
    },
    get$top: function(_) {
      return J.get$top$x(J.getBoundingClientRect$0$x(this._html$_element));
    }
  },
  CssRect: {
    "^": "MutableRectangle;",
...
["slick.column", "package:slickdart/slick_column.dart", , Z, {
  ...
  CheckboxSelectColumn: {
    ...
    }, "call$2", "get$handleSelectedRowsChanged", 4, 0, 56, 3, 31],
    ...
    }, "call$2", "get$handleKeyDown", 4, 0, 57, 3, 31],
    ...
    }, "call$2", "get$handleClick", 4, 0, 57, 3, 31],
    ...
    }, "call$2", "get$handleHeaderClick", 4, 0, 56, 58, 31],
    checkboxSelectionFormatter$5: [function(row, cell, value, columnDef, dataContext) {
      ...
      return;
    }, "call$5", "get$checkboxSelectionFormatter", 10, 0, 59, 60, 61, 14, 62, 63],
...
["slick.dnd", "package:slickdart/slick_dnd.dart", , E, {
  ...
  DragAndDrop: {
    ...
    }, "call$1", "get$_onDragStart", 2, 0, 64, 65],
...
["slick.grid", "package:slickdart/slick_grid.dart", , R, {
  ...
  SlickGrid: {
    ...
    }, "call$2", "get$handleSelectedRangesChanged", 4, 0, 67, 3, 68],
    ...
    }, "render$0", "call$1", "call$0", "get$render", 0, 2, 69, 16],
    ...
    }, "resizeCanvas$0", "call$1", "call$0", "get$resizeCanvas", 0, 2, 70, 16, 3],
    ...
    }, "defaultFormatter$4", "call$5", "call$3", "call$4", "get$defaultFormatter", 6, 4, 71, 16, 16, 60, 61, 14, 62, 63],
    ...
    rowsToRanges$1: function(rows) {
      ...
      ranges = [];
      lastCell = this.columns.innerList.length - 1;
    ...
    cleanUpCells$2: function(range, row) {
      ...
      cacheEntry = this.rowsCache.$index(0, row);
      cellsToRemove = [];
      for (t2 = cacheEntry.get$cellNodesByColumnIdx().get$keys(), t3 = t2._map, t2 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null), [H.getTypeArgumentByIndex(t2, 0)]), t2._cell = t2._map._first, t3 = this.columns.innerList, t4 = J.getInterceptor(row); t2.moveNext$0();) {
    ...
    }, "call$1", "get$handleClick", 2, 0, 64, 3],
    ...
    }, "call$1", "get$handleDblClick", 2, 0, 64, 3],
    setFocus$0: function() {
    ...
    canCellBeSelected$2: function(row, cell) {
      ...
      if (!t1.$ge(row, this.data.length))
        if (!t1.$lt(row, 0)) {
          t1 = this.columns.innerList.length;
    ...
    }, "call$1", "get$handleHeaderRowScroll", 2, 0, 72, 3],
    ...
    }, "handleScroll$0", "call$1", "call$0", "get$handleScroll", 0, 2, 70, 16, 3],
    ...
    }, "call$1", "get$handleHeaderMouseEnter", 2, 0, 64, 3],
    ...
    }, "call$1", "get$handleHeaderContextMenu", 2, 0, 73, 3],
    ...
    }, "call$1", "get$handleHeaderClick", 2, 0, 72, 3],
    ...
    absBox$1: function(elem) {
      ...
      box = P.LinkedHashMap_LinkedHashMap$_literal(["top", t1.get$offsetTop(elem), "left", t1.get$offsetLeft(elem), "bottom", 0, "right", 0, "width", J.get$offsetWidth$x(t1.get$borderEdge(elem)._html$_element), "height", J.get$offsetHeight$x(t1.get$borderEdge(elem)._html$_element), "visible", true], null, null);
    ...
    }, "handleKeyDown$1", "call$2", "call$1", "get$handleKeyDown", 2, 2, 77, 16, 3, 31],
  ...
  SlickGrid_disableSelection_closure: {
    ...
    call$1: function($$target) {
      ...
      if ($$target != null) {
        ...
        t1.get$attributes($$target)._html$_element.setAttribute("unselectable", "on");
  ...
  SlickGrid_createColumnHeaders__closure0: {
    ...
    call$1: function(item) {
      ...
      columnDef = t1._attributes._html$_element.getAttribute("data-" + H.S(t1._toHyphenedName$1("column")));
      if (columnDef != null) {
        t1 = this.this_1;
  ...
  SlickGrid_setupColumnResize_closure2: {
    "^": "Closure:79;box_0,this_4,columnElements_5,resizeItem_6",
    call$1: [function(e) {
      ...
      for (t5 = t3.columns.innerList, cnt = 0; cnt < t1.length; ++cnt) {
        ...
        t5[cnt].set$previousWidth(J.get$offsetWidth$x(J.get$borderEdge$x(t1[cnt])._html$_element));
      }
  ...
  SlickGrid_setupColumnResize_closure3: {
    "^": "Closure:79;box_0,this_7,columnElements_8",
    call$1: [function(e) {
  ...
  SlickGrid_setupColumnResize_closure4: {
    "^": "Closure:79;box_0,this_9,columnElements_10,item_11",
    call$1: [function(e) {
      ...
      while (t5 < t2.length) {
        if (t5 < 0 || t5 >= t4.length)
          return H.ioore(t4, t5);
        t1.c_0 = t4[t5];
        newWidth = J.get$offsetWidth$x(J.get$borderEdge$x(t2[t5])._html$_element);
  ...
  SlickGrid__cleanUpAndRenderCells__helper: {
    "^": "Closure:81;box_0,this_1,range_2,stringArray_3,processedRows_4",
    call$1: function(row) {
...
["slick.selection", "package:slickdart/slick_selectionmodel.dart", , V, {
  ...
  RowSelectionModel: {
    "^": "SelectionModel;_grid,_ranges,_handler,_inHandler,_selection$_options,_defaults,onSelectedRangesChanged",
    destroy$0: function() {
    ...
    rowsToRanges$1: function(rows) {
      var ranges, lastCell, i, t1;
      ranges = [];
      lastCell = this._grid.columns.innerList.length - 1;
      for (i = 0; i < rows.length; ++i) {
        t1 = rows[i];
        ranges.push(B.Range$(t1, 0, t1, lastCell));
      }
    ...
    handleActiveCellChange$2: [function(e, data) {
      ...
      if (this._selection$_options.$index(0, "selectActiveRow") === true && J.$index$asx(data, "row") != null) {
        ...
        t1 = [B.Range$(t1.$index(data, "row"), 0, t1.$index(data, "row"), this._grid.columns.innerList.length - 1)];
        this._ranges = t1;
        this.onSelectedRangesChanged.notify$1(t1);
      }
    }, "call$2", "get$handleActiveCellChange", 4, 0, 83, 3, 39],
    handleKeyDown$2: [function(e, args) {
      ...
      return this.handleKeyDown$2(e, null);
    }, "handleKeyDown$1", "call$2", "call$1", "get$handleKeyDown", 2, 2, 84, 16, 3, 31],
    handleClick$2: [function(e, args) {
    ...
    }, "handleClick$1", "call$2", "call$1", "get$handleClick", 2, 2, 85, 16, 3, 31],
...
//# sourceMappingURL=CheckBox.dart.js.map
