...
if(J.kE(window.navigator.userAgent,"Android")&&J.kE(window.navigator.userAgent,"Chrome"))x.push("."+y+" .slick-viewport { -webkit-transform: translateZ(0);}")
