...
if(x!=null){x.Gv()
this.xs=null}if(Math.abs(this.xA-this.vR)>420||Math.abs(this.Hk-this.fk)>420){if(this.bG.t(0,"forceSyncScrolling")!==!0){x=Math.abs(this.xA-this.vR)
v=this.P7
if(typeof v!=="number")return H.s(v)
